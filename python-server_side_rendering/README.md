...
- [Client-side vs. Server-side vs. Pre-rendering for Web Apps: Templating Engines in Web Development](https://developer.mozilla.org/en-US/docs/Learn/Server-side/First_steps/Client-side_vs_server-side)
